> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [javascript.ruanyifeng.com](http://javascript.ruanyifeng.com/dom/node.html#toc19)
...
*   [Node.nodeName](#toc6)
*   [Node.nodeValue](#toc7)
*   [Node.textContent](#toc8)
*   [Node.baseURI](#toc9)
*   [Node.ownerDocument](#toc10)
*   [Node.nextSibling](#toc11)
*   [Node.previousSibling](#toc12)
*   [Node.parentNode](#toc13)
*   [Node.parentElement](#toc14)
*   [Node.firstChild，Node.lastChild](#toc15)
*   [Node.childNodes](#toc16)
*   [Node.isConnected](#toc17)
*   [Node 接口的方法](#toc18)
*   [Node.appendChild()](#toc19)
*   [Node.hasChildNodes()](#toc20)
*   [Node.cloneNode()](#toc21)
*   [Node.insertBefore()](#toc22)
*   [Node.removeChild()](#toc23)
*   [Node.replaceChild()](#toc24)
*   [Node.contains()](#toc25)
*   [Node.compareDocumentPosition()](#toc26)
*   [Node.isEqualNode()，Node.isSameNode()](#toc27)
*   [Node.normalize()](#toc28)
*   [Node.getRootNode()](#toc29)
*   [NodeList 接口](#toc30)
*   [概述](#toc31)
*   [NodeList.prototype.length](#toc32)
*   [NodeList.prototype.forEach()](#toc33)
*   [NodeList.prototype.item()](#toc34)
*   [NodeList.prototype.keys()，NodeList.prototype.values()，NodeList.prototype.entries()](#toc35)
*   [HTMLCollection 接口](#toc36)
*   [概述](#toc37)
*   [HTMLCollection.prototype.length](#toc38)
*   [HTMLCollection.prototype.item()](#toc39)
*   [HTMLCollection.prototype.namedItem()](#toc40)
*   [ParentNode 接口](#toc41)
*   [ParentNode.children](#toc42)
*   [ParentNode.firstElementChild](#toc43)
*   [ParentNode.lastElementChild](#toc44)
*   [ParentNode.childElementCount](#toc45)
*   [ParentNode.append()，ParentNode.prepend()](#toc46)
*   [ChildNode 接口](#toc47)
*   [ChildNode.remove()](#toc48)
*   [ChildNode.before()，ChildNode.after()](#toc49)
*   [ChildNode.replaceWith()](#toc50)
*   [参考链接](#toc51)
...
```
<base href="[http://www.example.com/page.html](http://www.example.com/page.html)"> 
```
...
```
// HTML 代码如下
// <img id="pic" src="[http://example.com/foo.jpg](http://example.com/foo.jpg)">
...
*   David Walsh, [HTML5 classList API](https://davidwalsh.name/classlist)
*   Derek Johnson, [The classList API](http://html5doctor.com/the-classlist-api/)
*   Mozilla Developer Network, [element.dataset API](https://davidwalsh.name/element-dataset)
*   David Walsh, [The element.dataset API](https://davidwalsh.name/element-dataset)