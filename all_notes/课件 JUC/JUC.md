...
![](assets/1562811518605.png)

解决虚假唤醒：查看API，java.lang.Object的wait方法

![](assets/1562810523532.png)
...
![](assets/1562812279119.png)

Condition：查看API，java.util.concurrent.locks

![](assets/1562812425080.png)

并提供了实现案例：

![](assets/1562812570735.png)
...
​		List接口有很多实现类，除了常用的ArrayList之外，还有Vector和SynchronizedList。
 ...
 ![](assets/1562826331284.png)

他们都有synchronized关键字，说明都是线程安全的。

![](assets/1562826499790.png)
...
![](assets/1562830411166.png)

再来看看CopyOnWriteArrayList的add方法：发现该方法是线程安全的

![](assets/1562829359583.png)
...
![](assets/1562830638509.png)

![](assets/1562830863791.png)
...
![](assets/1562999783113.png)



### 8.3.1. 线程池的7个重要参数

![](assets/1563002258102.png)
...
![](assets/1595131719599.png)

子线程读取不到主线程修改后的flag值，陷入死循环程序无法结束。

接下来添加volatile关键字再试试：

![](assets/1595131854559.png)

打印结果如下：子线程可以读取的新值并结束子线程

![](assets/1595132060909.png)
...
![](assets/1597722920432.png)



给a, b添加volatile关键字

![](assets/1597722989205.png)
...
![](assets/1595139881680.png)

测试结果依然不是1000，如下：

![](assets/1595139950199.png)

说明volatile关键字不能保证原子性。

给incr方法添加同步锁试试：

![](assets/1595140034590.png)

测试：

![](assets/1595140073777.png)
...
![](assets/1595170303332.png)

测试结果如下：

![](assets/1595170398079.png)
...
![](assets/1595502744412.png)

把jdk文档中的案例copy到我们工程中：

 ![](assets/1595506276170.png)
